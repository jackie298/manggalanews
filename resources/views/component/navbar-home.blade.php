                ...
                <div class="container">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto social-icons">
                            <a href="https://www.facebook.com/ManggalaNews/" class="social-icon"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 mt-2 mb-3">
                            <div class="category-bar-wrapper">
                                <div class="container">
                                    <div class="category-bar d-flex align-items-center overflow-auto">
